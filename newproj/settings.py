...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(FILE_ROOT, 'dev'.db),                      # Or path to database file if using sqlite3.
...
MEDIA_URL = posixpath.join(WEB_ROOT, 'media/')
...
STATIC_URL = posixpath.join(WEB_ROOT, 'static/')
...
STATICFILES_DIRS = (
    ...
    os.path.join(FILE_ROOT, 'static_incoming'),
)
...
SECRET_KEY = '((x&amp;5vofps08(&amp;rqx(c9=-)d3006ur-%m9kr-^3r=2+!ysl-gd'
